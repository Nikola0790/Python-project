...
from django_1.views import hello, drawn_number, random_max_number, random_number, hello_name, articles, bands_albums, number_range_view, form, temp_convert, set_session, show_session, delete_session, my_view, add_to_session, show_all_session
